...
import json 
import os
from vModel.AtomTypes import AtomicProperties
...
class VisMolConfig:
    ...
    def __init__ (self, vm_session):
        ...
        self.gl_parameters      =     {
                                  ...
                                  #'background_color'           : [0.15, 0.15, 0.15, 1.0]    ,  #gray
                                  ...
                                  'ribbon_type'                : 2                    ,  # 0 - no detail       1 - Charlitos'style
                                  ...
                                  'sphere_quality'             : 0                    ,  # Quality for real spheres - 1 if default
                                  ...
                                  'gridsize'                   : 0.8               , # for bond distance calculation
                                  'maxbond'                    : 2.4                 , # for bond distance calculation
                                  'bond_tolerance'             : 1.4                  , # for bond distance calculation
                                 
                                  #'atom_types'                 : self.ATOM_TYPES      ,
                                 }
        
        #self.Save_EasyHybrid_ConfigFile ()                      
        #try:
        #    self.Load_EasyHybrid_ConfigFile ()                 
        #except:
        #    pass
            
        #self.atom_types = AtomTypes(self)
    ...
    def Save_EasyHybrid_ConfigFile (self):
        ...
        #if not os.path.exists (path): 
        #    os.mkdir (path)
        path = '/home/fernando/programs/EasyHybrid3'
        filename = os.path.join(path,'EasyHybrid.config')
        filename2 = os.path.join(path,'EasyHybrid_aType.config')
        
        json.dump(self.gl_parameters, open(filename , 'w'), indent=2)
        json.dump(self.ATOM_TYPES   , open(filename2, 'w'), indent=4)



    def Load_EasyHybrid_ConfigFile (self):
        """ Function doc """
        path = '/home/fernando/programs/EasyHybrid3/EasyHybrid.config'
        self.gl_parameters= json.load(open(path)) 
        
        #path = os.path.join(path,'.config', 'EasyHybrid', 'EasyHybrid.config')
        ##.config
...
ATOM_TYPES = {
            ...
            #'C'  : [ 6,   [0.      , 1.0     , 0.      ], [ 80, 180, 180], [255, 181, 181],  0.680000 , 0.770000 , 1.950000 ],#                                                          0.67, 1.70, 0.77 ],	
            'C'  : [ 6,   [138/255,  100/255,  226/255], [ 80, 180, 180], [255, 181, 181],  0.680000 , 0.770000 , 1.950000 ],#                                                          0.67, 1.70, 0.77 ],	
            #'C'  : [ 6,   [0.01,  0.01,  0.01], [ 80, 180, 180], [255, 181, 181],  0.680000 , 0.770000 , 1.950000 ],#                                                          0.67, 1.70, 0.77 ],	
            
            'N'  : [ 7,   [0.050000, 0.050000, 1.000000], [  0, 160,   0], [144, 144, 144],  0.680000 , 0.700000 , 1.850000 ],#                                                          0.56, 1.55, 0.75 ],	
            'O'  : [ 8,   [1.000000, 0.050000, 0.050000], [ 60,  60, 150], [ 48,  80, 248],  0.680000 , 0.660000 , 1.700000 ],#                                                          0.48, 1.52, 0.73 ],	
            'F'  : [ 9,   [0.700000, 1.000000, 1.000000], [160,   0,   0], [255,  13,  13],  0.640000 , 0.611000 , 1.730000 ],#                                                          0.42, 1.47, 0.71 ],	
            'Ne' : [ 10,  [0.700000, 0.890000, 0.960000], [  0, 160, 160], [144, 224,  80],  1.120000 , 0.700000 , 1.540000 ],#                                                          0.38, 1.54, 0.69 ],	
            'Na' : [ 11,  [0.670000, 0.360000, 0.950000], [180, 180, 180], [179, 227, 245],  1.1      , 0.66	 , 1.270000 ],#                                                          1.90, 2.27, 1.54 ],	
            'Mg' : [ 12,  [0.540000, 1.000000, 0.000000], [130,  90,  30], [171,  92, 242],  1.100000 , 1.360000 , 1.730000 ],#                                                          1.45, 1.73, 1.30 ],	
            'Al' : [ 13,  [0.750000, 0.650000, 0.650000], [ 90, 130,  30], [138, 255,   0],  1.350000 , 1.180000 , 2.050000 ],#                                                          1.18, 0.30, 1.18 ],	
            'Si' : [ 14,  [0.500000, 0.600000, 0.600000], [100, 100, 150], [191, 166, 166],  1.200000 , 0.937000 , 2.100000 ],#                                                          1.11, 2.10, 1.11 ],	
            'P'  : [ 15,  [1.000000, 0.500000, 0.000000], [ 60,  60,  60], [240, 200, 160],  1.100000 , 0.890000 , 2.080000 ],#                                                          0.98, 1.80, 1.06 ],	
...
class AtomTypes:
    ...
    def __init__ (self, vConfig = None):
        """ Class initialiser """
        self.vConfig = vConfig
        self.ATOM_TYPES = self.vConfig.gl_parameters['atom_types']# atom_types
        self.ATOM_TYPES_BY_ATOMICNUMBER = self.vConfig.ATOM_TYPES_BY_ATOMICNUMBER
        #self.hydrogen = ['H','HA','HB','HD','HE','HH','HB2','HB3','HG','HD11','HD12','HD13','HD21','HD22','HD23','HNC','H14','H15','H16','H17','H18','H19','H20','H21','H22','H24','1HB','2HB','3HB','H1']
        #self.carbon   = ['CA','C','CB','CD','CE','CG','CD1','CD2','CE1','CE2','CZ']
        #self.oxygen   = ['O','OD1','OD2', 'OW', 'OH', 'OH2', 'OXT']
        #self.nitrogen = ['N','NH','NH1', 'NH2', 'NH3']
        #self.magnesium= ['Mg','MG']
